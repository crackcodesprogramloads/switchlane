  ...
  return (
    <div className="relative w-[42%] h-[60%] flex flex-col items-center gap-3">
      <div className="relative w-full h-full gap-3 flex flex-col items-center">
        <div className="w-full h-1/2 px-12 flex flex-row items-center justify-center gap-12 border-l border-t border-gray-600 hover:border-gray-400 rounded-lg shadow-[0px_0px_50px] shadow-sky-700/70">
        ...
        <Image
          ...
          height={55}
        />
        <span className="w-[85%] h-2/3 px-16 flex flex-row items-center justify-center gap-20 border-l border-t border-gray-600 hover:border-gray-400 rounded-lg shadow-[0px_0px_50px] shadow-sky-700/70">
